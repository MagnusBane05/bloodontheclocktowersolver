...
# valid_worlds, conflicting_worlds = combine_worlds([investigator_worlds, washerwoman_worlds, soldier_worlds, execution_worlds, night_death_worlds])
saint_worlds = create_worlds_from_claim(game, saint_claim)
# valid_worlds, conflicting_worlds = combine_worlds([valid_worlds, saint_worlds])
# valid_worlds, conflicting_worlds = combine_worlds([investigator_worlds, washerwoman_worlds, soldier_worlds, execution_worlds, night_death_worlds, saint_worlds])
...
zeros = np.zeros((game['players'],27))
...
evil_players["evil"] = player_characters[Role.ANY_OTHER.name] + player_characters[Role.ANY_OTHER_EVIL.name] + player_characters[Role.ANY_OTHER_MINION.name] + player_characters[Role.NON_DEMON.name] + player_characters[Role.POISONER.name] + player_characters[Role.SPY.name] + player_characters[Role.SCARLET_WOMAN.name] + player_characters[Role.BARON.name] + player_characters[Role.IMP.name]
...
demon_players["demon"] = player_characters[Role.ANY_OTHER.name] + player_characters[Role.ANY_OTHER_EVIL.name] + player_characters[Role.IMP.name]
